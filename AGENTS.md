...
- Schema: `src/lib/db/schema.ts` — **90 tables** across government structure, factbook, Civica Index scoring and research panels, Pulse, provenance, and organizations
