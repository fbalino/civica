...
- Schema: `src/lib/db/schema.ts` — **72 tables** across government structure, factbook, Civica Index scoring and research panels, Pulse, provenance, and organizations
...
- `research-evidence-retention/v1` protects the registered evidence-bearing relations with
