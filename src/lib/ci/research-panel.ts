...
export const LONGITUDINAL_VALIDATION_RELEASE_ID = "ci-longitudinal-validation-labels-2000-2022-v2" as const;
export const K1_UNCERTAINTY_INPUT_RELEASE_ID = "ci-k1-uncertainty-inputs-2024-v2" as const;
