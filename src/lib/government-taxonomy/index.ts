...
> = {
  parliamentary_democracy: {
    ...
    colorVar: "var(--gov-parl)",
    fallback: "var(--gov-parl)",
    order: 100,
  },
  presidential_republic: {
    label: "Presidential republic",
    colorVar: "var(--gov-pres)",
    fallback: "var(--gov-pres)",
    order: 200,
  },
  semi_presidential: {
    label: "Semi-presidential",
    colorVar: "var(--gov-semi)",
    fallback: "var(--gov-semi)",
    order: 300,
  },
  constitutional_monarchy: {
  ...
  one_party_state: {
    ...
    colorVar: "var(--gov-one)",
    fallback: "var(--gov-one)",
    order: 600,
  },
  military_rule: {
    label: "Military rule",
    colorVar: "var(--gov-mil)",
    fallback: "var(--gov-mil)",
    order: 700,
  },
  theocracy: {
    label: "Theocracy",
