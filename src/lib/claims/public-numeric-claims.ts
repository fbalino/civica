...
export const PUBLIC_NUMERIC_CLAIMS: readonly PublicNumericClaimRegistration[] =
  [
    ...
    runtimeClaim(
      ...
      "src/app/elections/ElectionsClient.tsx",
      "/elections/ElectionsClient.tsx",
      "the {coverage.baselineRows} -row baseline",
      "checked election qualification artifact with generic outage copy",
    ),
    runtimeClaim(
      "elections.source-rights-coverage",
      "src/app/elections/ElectionsClient.tsx",
      "/elections/ElectionsClient.tsx",
      "{coverage.turnoutRows} turnout fields",
      "checked field-evidence and source-rights audit",
    ),
    runtimeClaim(
