...
const indexAnalysisReplayInput = {
  path: "data/releases/ci-index-analysis-replay-inputs-2026-07-18-v1/manifest.v1.json",
  sha256: "16e3dc49b49a3a6b1c7915bb353fe6f4a1efb80b4ca32f3d05c592b92afe5099",
} as const;
...
export const STATISTICAL_ANALYSIS_REPRODUCIBILITY: readonly StatisticalAnalysisReproducibilityRecord[] = [
  {
    ...
    inputArtifacts: [panelInput, indexAnalysisReplayInput],
    derivedArtifacts: [
    ...
    methodArtifacts: [{ path: "scripts/generate-index-dimensionality-analysis.ts", sha256: "fc46675a3427af463c42c3e3edb9eea7d8408952b5c54504600ee4f023eeea13" }],
    seeds: [],
    tolerance: "byte_exact",
  },
  {
    ...
    inputArtifacts: [panelInput, indexAnalysisReplayInput],
    methodArtifacts: [{ path: "scripts/generate-index-validity-analysis.ts", sha256: "6734f7c723ddda6b971165b379f3a467705825c4c8a70dcade99c611fbc0555c" }],
  ...
  },
  {
    ...
    inputArtifacts: [panelInput, indexAnalysisReplayInput],
    methodArtifacts: [{ path: "scripts/generate-index-incremental-information.ts", sha256: "407b9fd3da3cbbe9db8829db67b5b349dd424ab203282f11843a028565c938a4" }],
  ...
  },
  {
    ...
    inputArtifacts: [panelInput, longitudinalInput, indexAnalysisReplayInput],
    methodArtifacts: [{ path: "scripts/generate-index-longitudinal-analysis.ts", sha256: "e53edf20f911a753e06f64aa7395303a1c33b28a4eb72641b9c99d53a194b487" }],
  ...
  },
  {
    ...
    inputArtifacts: [...oosStaticInputs, indexAnalysisReplayInput],
    methodArtifacts: [{ path: "scripts/generate-index-oos-validation.ts", sha256: "c239f8fa5ebd82ae02cc91542945617284eb8e1f2d3d0526d105d50e6811d532" }],
    seeds: [],
    tolerance: "byte_exact",
  },
  {
    ...
    inputArtifacts: [panelInput, uncertaintyInput, dimensionalityResult, longitudinalResult, indexAnalysisReplayInput],
    methodArtifacts: [{ path: "scripts/generate-index-sensitivity-analysis.ts", sha256: "16e8cebf1c7504b2fe1b853e04bf662eef454d42f9c8c8aaf3e40aeaaafdbb90" }],
    seeds: [],
    tolerance: "byte_exact",
  },
  {
