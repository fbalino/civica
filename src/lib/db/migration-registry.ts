...
export const MIGRATION_ARTIFACTS: readonly MigrationArtifact[] = [
  ...
  shared("0026_magenta_xavin", "drizzle/authoritative/0026_magenta_xavin.sql", "schema", "journaled"),
  ...
  shared("0031_hot_saracen", "drizzle/authoritative/0031_hot_saracen.sql", "mixed", "journaled"),
  ...[
