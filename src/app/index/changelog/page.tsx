    ...
    <main className="civica-changelog-page">
      ...
      {countryFilter && (
        <div className="ci-scope-banner">
          ...
          <Link href="/index/changelog">Show all countries →</Link>
        </div>
      )}
      ...
      <div className="filter-bar" role="group" aria-label="Filter events">
        ...
        <form action="/index/changelog" method="get" className="search-form">
          {countryFilter && (
      ...
      {hasData && grouped.length === 0 && (
        <div className="ci-empty">
          ...
          <Link href={qParam ? `/index/changelog?${qParam}` : "/index/changelog"}>
            Clear filters
          </Link>
        </div>
      )}
      ...
      <footer className="ci-page-footer">
        <Link href="/index">Back to rankings</Link>
        <Link href="/index/methodology">Methodology</Link>
        <Link href="/index/government-types">By government type</Link>
