...
export const metadata: Metadata = {
  ...
  description:
    "Civica Atlas accepts private expressions of interest in the five areas named by the charter: governance measurement, political event data, research-data curation, data-heavy accessibility, and source rights. Fernando Balino reads each application. Submission does not confer membership, a review role, or endorsement.",
  alternates: {
