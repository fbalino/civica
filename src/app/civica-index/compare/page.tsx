...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://civicaatlas.org/civica-index/compare" },
  openGraph: {
    ...
    url: "https://civicaatlas.org/civica-index/compare",
  },
};
        ...
        <>
          ...
          <footer className="ci-page-footer">
            {ordered.map((country) => (
              <Link
                key={country.jurisdiction.slug}
                href={`/civica-index/${country.jurisdiction.slug}`}
              >
