...
export const metadata: Metadata = {
  title: "Civica Index Methodology v1.0 — Archive",
  description:
    "The original (v1.0) Civica Index methodology, archived. Live scores reflect this calculation until the v2.0 cut-over in Q3 2026. Six weighted dimensions including HDI and Security; min-max normalization; merged Civica Pulse scalar.",
  alternates: { canonical: "https://civicaatlas.org/civica-index/methodology/v1" },
  ...
  return (
    <div className="civica-methodology-layout">
      ...
      <article className="meth-article">
        ...
        <h1 className="page-title">Civica Index methodology — v1.0 archive.</h1>
        <div className="page-meta">
          <span>Version {version} (archive)</span>
          <span className="dim">·</span>
          <span>{published}</span>
          <span className="dim">·</span>
          <span>Superseded at Q3 2026 cut-over</span>
        </div>

        <div className="meth-rebuild-banner" role="note">
          <strong>This is the v1.0 archive.</strong> The methodology
          described on this page is what published scores currently
          reflect — and what cited values labeled &ldquo;Civica Index
          2026 Q2 (v1.0)&rdquo; will resolve to forever. After the v2.0
          cut-over (target Sept 30, 2026), the live{" "}
          <Link href="/civica-index/methodology">methodology page</Link>{" "}
          will describe v2.0; this archive remains accessible for
          longitudinal reference and citation continuity.
        </div>
