...
export const metadata: Metadata = {
  title: "Country Outcomes by Government Type | Civica",
  description:
    "Explore how country outcomes like HDI, happiness, press freedom, and corruption vary across government types. Compare 195 countries.",
  alternates: { canonical: "https://civicaatlas.org/outcomes" },
  openGraph: {
    title: "Country Outcomes by Government Type | Civica",
    description:
      "Explore how country outcomes like HDI, happiness, press freedom, and corruption vary across government types. Compare 195 countries.",
    url: "https://civicaatlas.org/outcomes",
  },
};
