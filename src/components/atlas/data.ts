...
export const COUNTRIES: Country[] = [
  { id: "usa", name: "United States", leader: "Donald Trump", gov: "Federal Republic", region: "Americas", pop: "334M", gdp: "$27.4T", capital: "Washington, D.C.", featured: true },
  { id: "can", name: "Canada", leader: "Mark Carney", gov: "Parliamentary Dem.", region: "Americas", pop: "40M", gdp: "$2.1T", capital: "Ottawa" },
  { id: "mex", name: "Mexico", leader: "Claudia Sheinbaum", gov: "Federal Republic", region: "Americas", pop: "129M", gdp: "$1.8T", capital: "Mexico City" },
  { id: "bra", name: "Brazil", leader: "Luiz Inacio Lula da Silva", gov: "Federal Republic", region: "Americas", pop: "216M", gdp: "$2.2T", capital: "Brasilia", featured: true },
  { id: "arg", name: "Argentina", leader: "Javier Milei", gov: "Federal Republic", region: "Americas", pop: "46M", gdp: "$640B", capital: "Buenos Aires" },
  { id: "gbr", name: "United Kingdom", leader: "Keir Starmer", gov: "Parliamentary Dem.", region: "Europe", pop: "68M", gdp: "$3.3T", capital: "London", featured: true },
  { id: "fra", name: "France", leader: "Emmanuel Macron", gov: "Semi-Presidential", region: "Europe", pop: "68M", gdp: "$3.0T", capital: "Paris", featured: true },
  { id: "deu", name: "Germany", leader: "Friedrich Merz", gov: "Federal Republic", region: "Europe", pop: "84M", gdp: "$4.4T", capital: "Berlin", featured: true },
  { id: "esp", name: "Spain", leader: "Pedro Sanchez", gov: "Parliamentary Dem.", region: "Europe", pop: "48M", gdp: "$1.6T", capital: "Madrid" },
  { id: "ita", name: "Italy", leader: "Giorgia Meloni", gov: "Parliamentary Dem.", region: "Europe", pop: "59M", gdp: "$2.2T", capital: "Rome" },
  { id: "rus", name: "Russia", leader: "Vladimir Putin", gov: "Federal Republic", region: "Europe", pop: "144M", gdp: "$2.0T", capital: "Moscow" },
  { id: "egy", name: "Egypt", leader: "Abdel Fattah el-Sisi", gov: "Presidential Rep.", region: "Africa", pop: "110M", gdp: "$400B", capital: "Cairo" },
  { id: "nga", name: "Nigeria", leader: "Bola Ahmed Tinubu", gov: "Federal Republic", region: "Africa", pop: "224M", gdp: "$510B", capital: "Abuja" },
  { id: "zaf", name: "South Africa", leader: "Cyril Ramaphosa", gov: "Parliamentary Dem.", region: "Africa", pop: "60M", gdp: "$410B", capital: "Pretoria" },
  { id: "ken", name: "Kenya", leader: "William Ruto", gov: "Presidential Rep.", region: "Africa", pop: "55M", gdp: "$115B", capital: "Nairobi" },
  { id: "chn", name: "China", leader: "Xi Jinping", gov: "One-Party State", region: "Asia", pop: "1.41B", gdp: "$17.9T", capital: "Beijing" },
  { id: "ind", name: "India", leader: "Narendra Modi", gov: "Federal Republic", region: "Asia", pop: "1.43B", gdp: "$3.7T", capital: "New Delhi" },
  { id: "jpn", name: "Japan", leader: "Sanae Takaichi", gov: "Parliamentary Monarchy", region: "Asia", pop: "124M", gdp: "$4.2T", capital: "Tokyo", featured: true },
  { id: "kor", name: "South Korea", leader: "Lee Jae Myung", gov: "Presidential Rep.", region: "Asia", pop: "52M", gdp: "$1.7T", capital: "Seoul" },
  { id: "sau", name: "Saudi Arabia", leader: "Salman bin Abdulaziz Al Saud", gov: "Absolute Monarchy", region: "Asia", pop: "36M", gdp: "$1.1T", capital: "Riyadh", featured: true },
  { id: "idn", name: "Indonesia", leader: "Prabowo Subianto", gov: "Presidential Rep.", region: "Asia", pop: "278M", gdp: "$1.4T", capital: "Jakarta" },
  { id: "aus", name: "Australia", leader: "Anthony Albanese", gov: "Parliamentary Dem.", region: "Oceania", pop: "26M", gdp: "$1.7T", capital: "Canberra" },
  { id: "nzl", name: "New Zealand", leader: "Christopher Luxon", gov: "Parliamentary Dem.", region: "Oceania", pop: "5M", gdp: "$250B", capital: "Wellington" },
];
...
export function getDefaultChamberData(countryId: string): ChamberData {
  return CHAMBERS[countryId] || {
    lower: {
      name: "Legislature", total: 0,
      sub: "Composition data not yet available",
      parties: [],
    },
    upper: null,
    bills: [],
