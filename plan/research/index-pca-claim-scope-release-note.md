# PCA claim-scope correction — research release note

Version: `civica-index-pca-scope-2026-07-v1`

- Recasts the Phase 5.3 PCA appendix as a historical weight-derivation record.
- States that the run used 46 countries from one 2023 cross-section.
- Removes claims that the cross-section validates a universal or longitudinal governance factor.
