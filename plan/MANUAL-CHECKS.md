...
- **QA-018 · Owner — pending sign-off:** review `plan/evidence/QA-018/attempt-06-isolated-preview-smoke-2026-07-26.md` and the linked bounded records. Record a dated approval or rejection of the isolated technical run. The Preview passed through migration head `0050_index_release_header_contract`, exact release pointers, cache/error/idempotent-dry-run checks, unchanged source freshness, and responsive browser QA; this review does not authorize production.
