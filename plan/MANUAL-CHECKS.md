...
- **EXP-006 · Owner:** review the de-orange pilot sheet (`plan/evidence/EXP-006/pilot-sheet.html`) covering Japan, Bahrain, Barbados, Denmark, Guinea, Guyana, and Vatican City, with France and the United Kingdom shown as regeneration candidates. Decide: approve recipe B for the corpus batch (EXP-007/008), request recipe adjustments, or supersede grading with a corpus regeneration wave (owner is separately considering full-color redo and reports most dark variants look artificial — that decision would fold into EXP-009 scope).
