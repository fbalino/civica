...
- **EXP-006 · Owner:** pick the corpus strength on the interactive sheet (`plan/evidence/EXP-006/pilot-sheet-v2.html`, slider 0–100; default 25 = very slight). The v1 split-tone (recipe B) was owner-rejected on 2026-07-12 — the corpus's warm tint is intentional and only its intensity comes down. The chosen value fixes the contract thresholds and becomes the EXP-007/008 batch setting. France and the United Kingdom remain regeneration candidates, and the possible full-color regeneration wave remains a separate owner consideration (EXP-009 scope).
