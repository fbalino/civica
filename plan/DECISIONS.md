...
**Decision:** Adopt `civica-research-publication-governance/v1`. Fernando Balino is the current accountable human for data, methodology, editorial copy, corrections, releases, security, source rights, reviewer-independence process, conflicts, and emergency action. Each domain has required evidence and a fail-closed condition. Agents and models may prepare and test work but cannot author, approve, publish, spend, waive conflicts, select or contact reviewers, accept risk, or restore a suspended surface. Future delegation requires a named, scoped, dated appointment. Independent reviewers own their conclusions; original reports remain separate from the author's response.
