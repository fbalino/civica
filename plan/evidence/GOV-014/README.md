...
The current `governance-evidence-review-packet-2026-07-v3` is the GOV-014 Index review packet after a task-specific closure audit. Its 50-artifact inventory and 11 bounded questions include:
...
- the canonical GOV-003 project disclosure, bound by exact path, bytes, and SHA-256 rather than rewritten packet prose.
