...
- The country-map and masthead-photo previews and FlagCDN pixels are masked
  while retaining their layout: QA-016 separately verifies provider and
  fallback behavior, so transient third-party responses cannot make a Civica
  page baseline flaky.
