...
const checked = JSON.parse(readFileSync("data/releases/civica-atlas-review-packet-2026-07-v1/manifest.v1.json", "utf8"));
assert.deepEqual(atlasReviewPacketErrors(), []);
assert.deepEqual(checked, buildAtlasReviewPacket());
assert.equal(readFileSync("data/releases/civica-atlas-review-packet-2026-07-v1/review-questionnaire.md", "utf8"), renderAtlasQuestions(checked));
assert.equal(readFileSync("data/releases/civica-atlas-review-packet-2026-07-v1/README.md", "utf8"), renderAtlasReadme(checked));
