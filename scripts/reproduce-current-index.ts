...
import spineArtifact from "../data/releases/ci-beta-r5-2024-Q4/jurisdiction-spine.v1.json";
import {
...
const outputPath = "data/releases/ci-beta-r5-2024-Q4/reproduction-manifest.v1.json";
...
async function main() {
  ...
  const manifest = {
    ...
    jurisdictionSpine: { path: "data/releases/ci-beta-r5-2024-Q4/jurisdiction-spine.v1.json", rowCount: spine.length, sha256: spineArtifact.sha256 },
    algorithm: { simulations: 0, randomization: "none; deterministic weighted composite", ranking: "competition on published integer score" },
